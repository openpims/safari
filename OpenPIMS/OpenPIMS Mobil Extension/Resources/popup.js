// OpenPIMS Extension Popup (Mobile Version)
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    loginButton.addEventListener('click', async function(e) {
        ...
        try {
            ...
            // Sende Daten an Safari Extension Handler (für native App Kommunikation)
            try {
    ...
    if (logoutButton) {
        logoutButton.addEventListener('click', async () => {
            try {
                // Sende Logout an Safari Extension Handler (für native App Kommunikation)
                try {
                    await browserAPI.runtime.sendNativeMessage("de.openpims.extension", {
                        action: "updateStorage",
                        isLoggedIn: false,
